...
class ElasticCharTCN(nn.Module):
    #Note different dropout rates for char tcn
    def __init__(
        self,
        input_size,
        output_size,
        ...
        super(ElasticCharTCN, self).__init__()
    ...
    #Note: Weight initialization is different for char tcn
