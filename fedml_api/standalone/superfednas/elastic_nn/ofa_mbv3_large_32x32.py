...
class OFAMobileNetV3_32x32(MobileNetV3):
    def __init__(
        self,
        n_classes=1000,
        bn_param=(0.1, 1e-5),
        ...
        super(OFAMobileNetV3_32x32, self).__init__(
    ...
    def config(self):
        return {
            "name": OFAMobileNetV3_32x32.__name__,
    ...
    def load_state_dict(self, state_dict, **kwargs):
        ...
        super(OFAMobileNetV3_32x32, self).load_state_dict(model_dict)
